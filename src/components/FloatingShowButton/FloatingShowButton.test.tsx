...
describe('FloatingShowButton', () => {
  ...
  describe('Visibility Control', () => {
    it('should render when isVisible is false', () => {
      const { getByTitle } = render(<FloatingShowButton {...defaultProps} isVisible={false} />);
    ...
    it('should not render when isVisible is true', () => {
      const { queryByTitle } = render(<FloatingShowButton {...defaultProps} isVisible={true} />);
  ...
  describe('Conditional Rendering', () => {
    it('should render nothing when isVisible is true (early return)', () => {
      const { queryByRole } = render(<FloatingShowButton {...defaultProps} isVisible={true} />);
    ...
    it('should render button container when isVisible is false', () => {
      const { getByRole } = render(<FloatingShowButton {...defaultProps} isVisible={false} />);
